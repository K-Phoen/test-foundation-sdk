...
class PanelBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\Trend\Options();
        }
        assert($this->internal->options instanceof \Grafana\Foundation\Trend\Options);
    ...
    {    
        ...
        if ($this->internal->fieldConfig->defaults->custom === null) {
            $this->internal->fieldConfig->defaults->custom = new \Grafana\Foundation\Trend\FieldConfig();
        }
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Trend\FieldConfig);

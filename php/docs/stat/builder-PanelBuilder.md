...
```php
colorMode(\Grafana\Foundation\Common\BigValueColorMode $colorMode)
```
...
```php
graphMode(\Grafana\Foundation\Common\BigValueGraphMode $graphMode)
```
...
```php
justifyMode(\Grafana\Foundation\Common\BigValueJustifyMode $justifyMode)
```
...
### <span class="badge object-method"></span> percentChangeColorMode

```php
percentChangeColorMode(\Grafana\Foundation\Common\PercentChangeColorMode $percentChangeColorMode)
```
...
### <span class="badge object-method"></span> showPercentChange

```php
showPercentChange(bool $showPercentChange)
```
...
```php
textMode(\Grafana\Foundation\Common\BigValueTextMode $textMode)
```

...
### <span class="badge object-method"></span> percent_change_color_mode

```python
def percent_change_color_mode(percent_change_color_mode: common.PercentChangeColorMode) -> typing.Self
```
...
### <span class="badge object-method"></span> show_percent_change

```python
def show_percent_change(show_percent_change: bool) -> typing.Self
```
...
### <span class="badge object-method"></span> wide_layout

```python
def wide_layout(wide_layout: bool) -> typing.Self
```

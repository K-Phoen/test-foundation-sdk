...
class PanelBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    public function selectedSeries(int $selectedSeries): static
    {
        ...
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\Datagrid\Options();
        }
        assert($this->internal->options instanceof \Grafana\Foundation\Datagrid\Options);
        $this->internal->options->selectedSeries = $selectedSeries;

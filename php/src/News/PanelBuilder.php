...
class PanelBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\News\Options();
        }
        assert($this->internal->options instanceof \Grafana\Foundation\News\Options);
        $this->internal->options->feedUrl = $feedUrl;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\News\Options);
        $this->internal->options->showImage = $showImage;

...
class Panel:
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "repeatPanelId" in data:
            args["repeatPanelId"] = data["repeatPanelId"]
...
class DashboardMeta:
    ...
    def to_json(self) -> dict[str, object]:
        ...
        if self.public_dashboard_access_token is not None:
            payload["publicDashboardAccessToken"] = self.public_dashboard_access_token
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "publicDashboardAccessToken" in data:
            args["public_dashboard_access_token"] = data["publicDashboardAccessToken"]

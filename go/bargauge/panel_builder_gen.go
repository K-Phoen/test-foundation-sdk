...
func (builder *PanelBuilder) ValueMode(valueMode common.BarGaugeValueMode) *PanelBuilder {
	...
	builder.internal.Options.(*Options).ValueMode = valueMode

	return builder
}

func (builder *PanelBuilder) NamePlacement(namePlacement common.BarGaugeNamePlacement) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).NamePlacement = namePlacement
...
func (builder *PanelBuilder) ShowUnfilled(showUnfilled bool) *PanelBuilder {
	...
	builder.internal.Options.(*Options).ShowUnfilled = showUnfilled

	return builder
}

func (builder *PanelBuilder) Sizing(sizing common.BarGaugeSizing) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).Sizing = sizing
...
func (builder *PanelBuilder) MinVizWidth(minVizWidth uint32) *PanelBuilder {
	...
	builder.internal.Options.(*Options).MinVizWidth = minVizWidth
...
func (builder *PanelBuilder) MinVizHeight(minVizHeight uint32) *PanelBuilder {
	...
	builder.internal.Options.(*Options).MinVizHeight = minVizHeight
...
func (builder *PanelBuilder) ReduceOptions(reduceOptions cog.Builder[common.ReduceDataOptions]) *PanelBuilder {
	...
	if err != nil {
		builder.errors["options.reduceOptions"] = err.(cog.BuildErrors)
		return builder
	}
	builder.internal.Options.(*Options).ReduceOptions = reduceOptionsResource
...
func (builder *PanelBuilder) MaxVizHeight(maxVizHeight uint32) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).MaxVizHeight = maxVizHeight
...
func (builder *PanelBuilder) applyDefaults() {
	...
	builder.Height(9)
	builder.Span(12)
	builder.DisplayMode("gradient")
	builder.ValueMode("color")
	builder.NamePlacement("auto")
	builder.ShowUnfilled(true)
	builder.Sizing("auto")
	builder.MinVizWidth(8)
	builder.MinVizHeight(16)
	builder.MaxVizHeight(300)
}

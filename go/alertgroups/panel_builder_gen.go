...
func NewPanelBuilder() *PanelBuilder {
	...
	builder.internal.Type = "alertGroups"
...
func (builder *PanelBuilder) Labels(labels string) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).Labels = labels

	return builder
}

// Name of the alertmanager used as a source for alerts
func (builder *PanelBuilder) Alertmanager(alertmanager string) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).Alertmanager = alertmanager

	return builder
}

// Expand all alert groups by default
func (builder *PanelBuilder) ExpandAll(expandAll bool) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).ExpandAll = expandAll

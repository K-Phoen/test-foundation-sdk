...
func (builder *PanelBuilder) ShowThresholdLabels(showThresholdLabels bool) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).ShowThresholdLabels = showThresholdLabels

	return builder
}

func (builder *PanelBuilder) ShowThresholdMarkers(showThresholdMarkers bool) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).ShowThresholdMarkers = showThresholdMarkers
...
func (builder *PanelBuilder) applyDefaults() {
	...
	builder.Height(9)
	builder.Span(12)
	builder.ShowThresholdLabels(false)
	builder.ShowThresholdMarkers(true)
	builder.Sizing("auto")
	builder.MinVizWidth(75)
	builder.MinVizHeight(75)
}

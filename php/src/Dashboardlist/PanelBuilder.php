...
class PanelBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        ...
        $this->internal->options->keepTime = $keepTime;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->includeVars = $includeVars;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->showStarred = $showStarred;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->showRecentlyViewed = $showRecentlyViewed;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->showSearch = $showSearch;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->showHeadings = $showHeadings;
    
        return $this;
    }
    public function showFolderNames(bool $showFolderNames): static
    {    
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\Dashboardlist\Options();
        }
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->maxItems = $maxItems;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->query = $query;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Dashboardlist\Options);
        $this->internal->options->folderUID = $folderUID;

...
func (builder *PanelBuilder) BucketSize(bucketSize int32) *PanelBuilder {
	...
	builder.internal.Options.(*Options).BucketSize = &bucketSize
...
func (builder *PanelBuilder) BucketOffset(bucketOffset int32) *PanelBuilder {
	...
	builder.internal.Options.(*Options).BucketOffset = &bucketOffset
...
func (builder *PanelBuilder) Combine(combine bool) *PanelBuilder {
	...
	builder.internal.Options.(*Options).Combine = &combine

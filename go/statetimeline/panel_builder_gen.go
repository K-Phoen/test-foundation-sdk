...
func (builder *PanelBuilder) RowHeight(rowHeight float64) *PanelBuilder {
	...
	builder.internal.Options.(*Options).RowHeight = rowHeight

	return builder
}

// Merge equal consecutive values
func (builder *PanelBuilder) MergeValues(mergeValues bool) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = &Options{}
	}
	builder.internal.Options.(*Options).MergeValues = &mergeValues

...
### <span class="badge object-method"></span> hide_tooltip

Controls if the tooltip is shown

```python
def hide_tooltip() -> typing.Self
```
...
### <span class="badge object-method"></span> show_tooltip

Controls if the tooltip is shown

```python
def show_tooltip() -> typing.Self
```

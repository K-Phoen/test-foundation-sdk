...
```go
func (builder *PanelBuilder) DisplayLabels(displayLabels []piechart.PieChartLabels) *PanelBuilder
```
...
```go
func (builder *PanelBuilder) PieType(pieType piechart.PieChartType) *PanelBuilder
```

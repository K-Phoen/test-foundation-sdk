...
class PanelBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\Table\Options();
        }
        assert($this->internal->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->options->frameIndex = $frameIndex;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->options->showHeader = $showHeader;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->options->showTypeIcons = $showTypeIcons;
    ...
    {    
        ...
        $this->internal->options->sortBy = $sortByResources;
    ...
    {    
        ...
        $this->internal->options->footer = $footerResource;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->options->cellHeight = $cellHeight;
    ...
    {    
        ...
        $this->internal->fieldConfig->defaults->custom->width = $width;
    ...
    {    
        ...
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->fieldConfig->defaults->custom->minWidth = $minWidth;
    ...
    {    
        ...
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->fieldConfig->defaults->custom->align = $align;
    ...
    {    
        ...
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->fieldConfig->defaults->custom->displayMode = $displayMode;
    ...
    {    
        ...
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->fieldConfig->defaults->custom->hidden = $hidden;
    ...
    {    
        ...
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->fieldConfig->defaults->custom->inspect = $inspect;
    ...
    {    
        ...
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->fieldConfig->defaults->custom->filterable = $filterable;
    ...
    {    
        ...
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->fieldConfig->defaults->custom->hideHeader = $hideHeader;

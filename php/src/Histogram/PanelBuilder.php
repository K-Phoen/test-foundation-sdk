...
class PanelBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\Histogram\Options();
        }
        assert($this->internal->options instanceof \Grafana\Foundation\Histogram\Options);
     ...
     */
    public function bucketOffset(int $bucketOffset): static
    {    
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\Histogram\Options();
        }
    ...
    public function lineWidth(int $lineWidth): static
    {
        ...
        if ($this->internal->fieldConfig->defaults->custom === null) {
            $this->internal->fieldConfig->defaults->custom = new \Grafana\Foundation\Histogram\FieldConfig();
        }
        assert($this->internal->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig);

...
class PanelBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->options === null) {
            $this->internal->options = new \Grafana\Foundation\Alertgroups\Options();
        }
        assert($this->internal->options instanceof \Grafana\Foundation\Alertgroups\Options);
        $this->internal->options->labels = $labels;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Alertgroups\Options);
        $this->internal->options->alertmanager = $alertmanager;
    ...
    {    
        ...
        assert($this->internal->options instanceof \Grafana\Foundation\Alertgroups\Options);
        $this->internal->options->expandAll = $expandAll;

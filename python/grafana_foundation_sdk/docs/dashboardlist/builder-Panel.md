...
### <span class="badge object-method"></span> show_folder_names

```python
def show_folder_names(show_folder_names: bool) -> typing.Self
```

### <span class="badge object-method"></span> show_headings

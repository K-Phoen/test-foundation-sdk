...
### <span class="badge object-method"></span> show_threshold_labels

```python
def show_threshold_labels(show_threshold_labels: bool) -> typing.Self
```

### <span class="badge object-method"></span> show_threshold_markers

```python
def show_threshold_markers(show_threshold_markers: bool) -> typing.Self
```
